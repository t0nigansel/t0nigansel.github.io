(function () {
  ...
  var I18N = {
    de: {
      ...
      "index.profile.tools.dd": "Schwerpunkt-Stack: Claude Code & Codex, Python und Java, JMeter, OWASP ZAP & Burp Suite, Selenium und Cypress, Docker/Kubernetes, GitLab CI/CD. Die komplette Toolliste steht im CV weiter unten.",
      "index.profile.approach.dt": "Arbeitsweise",
      "index.profile.approach.dd": "Risikobasiert, security-nah, automatisiert und AI-gestuetzt. Ich beginne mit dem Risiko, nicht mit Tools - was kann ausfallen, was missbraucht werden, was muss messbar bleiben - und baue daraus schlanke Teststrategien, automatisierte Checks und nachvollziehbare Reports. AI bleibt pruefbar, reproduzierbar und verifizierbar.",
      ...
      "index.timeline.h2": "Stationen, kurz und ehrlich",
    ...
    en: {
      ...
      "index.profile.tools.dt": "Tools",
      "index.profile.tools.dd": "Core stack: Claude Code & Codex, Python and Java, JMeter, OWASP ZAP & Burp Suite, Selenium and Cypress, Docker/Kubernetes, GitLab CI/CD. The full tool list is in the CV below.",
      "index.profile.approach.dt": "Approach",
      "index.profile.approach.dd": "Risk-based, security-aware, automated and AI-assisted. I start with risk, not tools - what can fail, what can be abused, what must stay measurable - then build lean test strategies, automated checks and traceable reports. AI stays reviewable, reproducible and verifiable.",
      ...
      "index.timeline.h2": "Stations, short and honest",
