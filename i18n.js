(function () {
  ...
  var I18N = {
    de: {
      ...
      "index.hero.title": "Toni Gansel",
      "index.hero.role": "Test Engineer fuer Sicherheit, Performance & AI-gestuetzte Automatisierung",
      "index.hero.underConstruction": "+++ Diese Homepage ist permanent im Umbau +++",
      "index.hero.copy": "Ich verbinde technische Umsetzung mit strategischem Qualitaetsmanagement, arbeite in agilen, interdisziplinaeren Teams und baue schlanke, risikoorientierte Testprozesse mit hohem Automatisierungsgrad.",
      "index.hero.chip1": "Application Security",
      "index.hero.chip2": "Performance & Last",
      "index.hero.chip3": "Teststrategie",
      "index.hero.chip4": "Risikobasiertes Testen",
      "index.hero.chip5": "Threat Modeling",
      "index.hero.chip6": "CI/CD-Automatisierung",
      ...
      "index.facts.available.dd": "ab September 2026",
      ...
      "index.profile.p": "Ich komme aus Softwareentwicklung, Test Engineering und Security Testing. Heute liegt mein Schwerpunkt auf AI Engineering an der Schnittstelle zu Qualitaet und Sicherheit.",
      "index.profile.focus.dt": "Fokus",
      "index.profile.focus.dd": "Dort, wo Softwareentwicklung, Security und Qualitaet zusammenlaufen: Secure SDLC, Application Security Testing, Threat Modeling, Performance Engineering, Testautomatisierung und der kontrollierte Einsatz von Coding Agents - mit Fokus auf Systeme, bei denen Fehler echte Folgen haben.",
      "index.profile.tools.dt": "Tools",
      "index.profile.tools.dd": "Vom AI-Coding-Agent ueber Test- und API-Automatisierung bis zu Security- und Lasttest-Werkzeugen. Die komplette Liste steht im CV unter \"Womit ich arbeite\".",
      "index.profile.approach.dt": "Arbeitsweise",
      "index.profile.approach.dd": "Ich beginne mit dem Risiko, nicht mit dem Tool, und automatisiere, was sich wiederholt. Die ausfuehrliche Denkweise steht im CV unter \"Wie ich denke\".",
      ...
      "index.cv.box1.li6": "Last- und Performancetests mit JMeter auf Kubernetes geplant und ausgewertet (RISE).",
      "index.cv.box2.h3": "Womit ich arbeite",
      "index.cv.box2.p1": "Claude Code, Codex, Python, Java, JavaScript, TypeScript, SQL, REST-APIs, Selenium, Cypress, Cucumber, Postman, Bruno, JUnit, JMeter, OWASP ZAP, Burp Suite, Nmap, SonarQube, Jenkins, GitLab CI, Docker, Kubernetes, Prometheus, Grafana, Jira und Zephyr Scale.",
      ...
      "index.timeline.kicker": "Werdegang",
      "index.timeline.h2": "Wo ich war, was ich getan habe",
      "index.timeline.freelance": "Freiberufler",
      "index.timeline.item1.period": "2026–heute",
      "index.timeline.item1.desc": "Test Engineer - Softwareentwicklung mit AI-Tools, Sicherheits- und Lasttests",
      "index.timeline.item2.desc": "Test Engineer - Performance- und E2E-Tests verteilter Systeme, Lasttest-Frameworks auf Kubernetes, Mentoring",
      "index.timeline.item3.desc": "Test Engineer - risikobasierte Teststrategien, Security- und Lasttests, CI/CD-nahe Qualitaetssicherung",
      "index.timeline.item4.desc": "Test Engineer - Penetrations- und Regressionstests, Koordination von Testteams, Fachpublikationen",
      "index.timeline.item5.desc": "Softwareentwickler - JEE-Entwicklung, Performance-Optimierung",
      "index.timeline.item6.desc": "Test Engineer - Keyword-basierte Tests, manuelle Tests",
      "index.timeline.item7.desc": "Softwareentwickler - JEE-Entwicklung, Build-Automatisierung, Serveradministration",
      ...
      "index.articlesTeaser.p": "LinkedIn-Artikel, Fachartikel-PDFs und Fachpublikationen - bis zurueck in die Sogeti-Zeit. Die komplette Liste liegt auf einer eigenen Seite.",
      ...
      "index.contact.p": "AI Engineering, Cybersecurity oder Quality Engineering? Schreib mir auf LinkedIn.",
      "index.contact.availability": "Remote-first verfuegbar fuer Unternehmen in DE und EU.",
      "index.contact.btnPrimary": "Auf LinkedIn schreiben",
      "index.contact.btnGithub": "GitHub-Projekte ansehen",
      ...
      "cert.all.h2": "Nach Themen sortiert, nicht nach Nostalgie.",
      "cert.all.p": "Jeder Titel verlinkt auf das jeweilige Zertifikat (PDF).",
      "cert.group.ai": "AI Engineering & Agents",
      "cert.group.security": "Security & LLM Red Teaming",
      "cert.group.testing": "Software Testing",
      "cert.group.cloud": "Cloud, Data & UX",
      ...
      "art.intro.h1": "Meine Artikel und Fachartikel.",
      ...
      "book.twominutepapers.blurb": "Kurze, begeisterte Zusammenfassungen frischer AI- und Grafik-Paper. Perfekt, wenn Du in zwei Minuten mitbekommen willst, was gerade Forschung moeglich macht.",
      "book.cat2.kicker": "Deep Dives",
      "book.cat2.h2": "Wo ich schlauer werde.",
      "book.cat2.p": "Tiefes, aktuelles Wissen. Kein Zertifikat, dafuer echtes Verstaendnis.",
      ...
      "book.cat3.kicker": "Lernen & Zertifizierung",
      "book.cat3.h2": "Wo ich lerne.",
      "book.cat3.p": "Strukturierte Kurse mit Zertifikat oder Badge.",
      ...
      "book.istqb.blurb": "Der Standard fuer Software-Testing-Zertifizierungen. Hier halte ich mein Testwissen aktuell und hole mir neue Module.",
    ...
    en: {
      ...
      "index.hero.figcaption": "AI Engineering · Cybersecurity · Quality Engineering",
      "index.hero.title": "Toni Gansel",
      "index.hero.role": "Test Engineer for Security, Performance & AI-assisted Automation",
      "index.hero.underConstruction": "+++ This homepage is permanently under construction +++",
      "index.hero.copy": "I combine hands-on engineering with strategic quality management, work in agile, cross-functional teams and build lean, risk-based test processes with a high degree of automation.",
      "index.hero.chip1": "Application Security",
      "index.hero.chip2": "Performance & Load",
      "index.hero.chip3": "Test Strategy",
      "index.hero.chip4": "Risk-based Testing",
      "index.hero.chip5": "Threat Modeling",
      "index.hero.chip6": "CI/CD Automation",
      ...
      "index.facts.available.dd": "from September 2026",
      ...
      "index.profile.p": "I come from software development, test engineering and security testing. Today my focus is on AI engineering at the intersection of quality and security.",
      "index.profile.focus.dt": "Focus",
      "index.profile.focus.dd": "Where software development, security and quality intersect: Secure SDLC, application security testing, threat modeling, performance engineering, test automation and the controlled use of coding agents - focused on systems where defects have real consequences.",
      "index.profile.tools.dt": "Tools",
      "index.profile.tools.dd": "From AI coding agents through test and API automation to security and load-testing tools. The full list is in the CV under \"What I work with\".",
      "index.profile.approach.dt": "Approach",
      "index.profile.approach.dd": "I start with risk, not the tool, and automate what repeats. The detailed mindset is in the CV under \"How I think\".",
      ...
      "index.cv.box1.li6": "Planned and evaluated load and performance tests with JMeter on Kubernetes (RISE).",
      "index.cv.box2.h3": "What I work with",
      "index.cv.box2.p1": "Claude Code, Codex, Python, Java, JavaScript, TypeScript, SQL, REST APIs, Selenium, Cypress, Cucumber, Postman, Bruno, JUnit, JMeter, OWASP ZAP, Burp Suite, Nmap, SonarQube, Jenkins, GitLab CI, Docker, Kubernetes, Prometheus, Grafana, Jira and Zephyr Scale.",
      ...
      "index.timeline.kicker": "Career",
      "index.timeline.h2": "Where I was, what I did",
      "index.timeline.freelance": "Freelance",
      "index.timeline.item1.period": "2026–today",
      "index.timeline.item1.desc": "Test Engineer - software development with AI tools, security and load testing",
      "index.timeline.item2.desc": "Test Engineer - performance and E2E testing of distributed systems, load-test frameworks on Kubernetes, mentoring",
      "index.timeline.item3.desc": "Test Engineer - risk-based test strategies, security and load testing, CI/CD-near QA",
      "index.timeline.item4.desc": "Test Engineer - penetration and regression testing, test team coordination, technical publications",
      "index.timeline.item5.desc": "Software Developer - JEE development, performance optimization",
      "index.timeline.item6.desc": "Test Engineer - keyword-driven and manual testing",
      "index.timeline.item7.desc": "Software Developer - JEE development, build automation, server administration",
      ...
      "index.articlesTeaser.p": "LinkedIn articles, technical-article PDFs and professional publications - going back to my Sogeti years. The full list lives on its own page.",
      ...
      "index.contact.p": "AI engineering, cybersecurity or quality engineering? Message me on LinkedIn.",
      "index.contact.availability": "Available remote-first for companies in Germany and the EU.",
      "index.contact.btnPrimary": "Message on LinkedIn",
      "index.contact.btnGithub": "View GitHub Projects",
      ...
      "cert.all.h2": "Grouped by topic, not by nostalgia.",
      ...
      "art.intro.h1": "My articles and technical articles.",
      ...
      "book.twominutepapers.blurb": "Short, enthusiastic summaries of fresh AI and graphics papers. Perfect if you want to catch up in two minutes on what research just made possible.",
      "book.cat2.kicker": "Deep Dives",
      "book.cat2.h2": "Where I get smarter.",
      "book.cat2.p": "Deep, current knowledge. No certificate, but real understanding.",
      ...
      "book.cat3.kicker": "Learning & Certification",
      "book.cat3.h2": "Where I learn.",
      "book.cat3.p": "Structured courses with a certificate or badge.",
      ...
      "book.istqb.blurb": "The standard for software testing certifications. This is where i keep my testing knowledge current and pick up new modules.",
